...
class BookmarksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'url' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-05-29 22:43:44',
                'modified' => '2019-05-29 22:43:44'
            ],
        ];
        parent::init();
    }
